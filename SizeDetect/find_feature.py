...
def find_features(img_org, img_contour):
    ...
    try:
        for ct in contours:
            ...
            if 4000 < cv2.contourArea(ct[0:round(len(ct)/2), :]) < 35000 and 220 < len(ct) < 480:
                ...
                cv2.drawContours(img_origin, [approx], 0, (255, 0, 0), 2)
                ...
                cv2.line(img_origin, (x1, y1), (x3, y3), (0, 0, 255), thickness=1)
                cv2.line(img_origin, (x1, y1), (x2, y2), (0, 0, 255), thickness=1)
                cv2.line(img_origin, (x2, y2), (x3, y3), (0, 0, 255), thickness=1)
