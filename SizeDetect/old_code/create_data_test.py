...
#
# # size 16
# txt16 = 'dataset/test/size16/dep16 ({0}).jpg'
# for i in range(10):
...
#     create_workbook("test.xlsx", i + 2, d1, d2, d3, 0)
#
# # size 18
# txt18 = 'dataset/test/size18/dep18 ({0}).jpg'
# for i in range(10):
#     img = cv2.imread(txt18.format(i))
#     img_org, img_contour = preprocessing_img(img)
#     image, center, d1, d2, d3 = find_features(img_org, img_contour)
#     create_workbook("test.xlsx", i + 12, d1, d2, d3, 1)
#
# # size 20
# txt20 = 'dataset/test/size20/dep20 ({0}).jpg'
# for i in range(10):
#     img = cv2.imread(txt20.format(i))
#     img_org, img_contour = preprocessing_img(img)
#     image, center, d1, d2, d3 = find_features(img_org, img_contour)
#     create_workbook("test.xlsx", i + 22, d1, d2, d3, 2)
